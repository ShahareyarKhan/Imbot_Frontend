        ...
        <section id='home'>
            ...
            <div className='flex flex-col min-h-[80vh] md:min-h-[90vh] items-center justify-center'>
                ...
                <div className='w-[90%] md:w-[80%]  mx-auto flex flex-col gap- '>
                    <h1 className='font-bold bg-gradient-to-r md:text-center from-indigo-500 via-purple-500 to-pink-500 bg-clip-text text-transparent text-4xl leading-[45px] md:leading-[80px] md:text-6xl py-7'>Create AI Chatbots And Get Instant, Concise Text Summaries Effortlessly.</h1>
